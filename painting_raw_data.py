...
TRAINING_PATH = "/home/xilm/kitti/raw_data/2011_09_26_drive_0084_sync/2011_09_26/2011_09_26_drive_0084_sync/"
TWO_CAMERAS = True
...
class Painter:
    def __init__(self, seg_net_index):
        ...
        self.root_split_path_calib = "/home/xilm/kitti/raw_data/2011_09_26_drive_0084_sync/2011_09_26/"
    ...
    # TODO: How to get the correct calibration infomation?
    def get_calib_fromfile(self, idx):
        calib_file = self.root_split_path_calib + 'calibfile.txt' 
    ...
    def run(self):
        num_image = 383 # total 383 frames
        for idx in tqdm(range(num_image)):
            ...
            scores_from_cam = self.get_score(sample_idx, "image_02/data/")
            scores_from_cam_r = self.get_score(sample_idx, "image_03/data/")
            ...
            np.save(self.save_path + ("%010d.npy" % idx), points)
